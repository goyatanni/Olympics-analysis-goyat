...
st.sidebar.image('https://images.rawpixel.com/image_png_800/cHJpdmF0ZS9sci9pbWFnZXMvd2Vic2l0ZS8yMDIyLTA4L2pvYjk1Mi0wMzItcC5wbmc.png')
...
if user_menu == 'Overall Analysis' :
    ...
    with col2:  # Place the content in the middle column
